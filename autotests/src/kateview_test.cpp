...
{
    QTest::addColumn<KTextEditor::View::CoordinatesToCursorFlags>("flags");

    QTest::newRow("ClosestCursorOutsideText") << KTextEditor::View::CoordinatesToCursorFlags{};
    QTest::newRow("InvalidCursorOutsideText") << KTextEditor::View::InvalidCursorOutsideText;
}
