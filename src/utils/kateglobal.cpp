...
KTextEditor::EditorPrivate::EditorPrivate(QPointer<KTextEditor::EditorPrivate> &staticInstance)
    ...
    , m_aboutData(QStringLiteral("katepart"),
                  ...
                  i18n("(c) 2000-2025 The Kate Authors"),
                  QString(),
    ...
    , m_replaceHistoryModel(nullptr)
{
    ...
    // fill about data
    //
    m_aboutData.addAuthor(i18n("Christoph Cullmann"), i18n("Maintainer"), QStringLiteral("cullmann@kde.org"), QStringLiteral("https://cullmann.dev"));
    ...
    m_aboutData.addAuthor(i18n("Joseph Wenninger"), i18n("Core Developer"), QStringLiteral("jowenn@kde.org"));
    ...
    m_aboutData.addAuthor(i18n("Bernhard Beschow"), i18n("Developer"), QStringLiteral("bbeschow@cs.tu-berlin.de"));
    m_aboutData.addAuthor(i18n("Anders Lund"), i18n("Core Developer"), QStringLiteral("anders@alweb.dk"));
    ...
    m_aboutData.addAuthor(i18n("Gerald Senarclens de Grancy"), i18n("QA and Scripting"), QStringLiteral("oss@senarclens.eu"));
...
void KTextEditor::EditorPrivate::copyToClipboard(const QString &text, const QString &fileName)
{
    ...
    // cut after X entries
    auto entry = ClipboardEntry{.text = text, .fileName = fileName};
...
QStringListModel *KTextEditor::EditorPrivate::searchHistoryModel()
{
    if (!m_searchHistoryModel) {
        ...
        const QStringList history = cg.readEntry("Search History", QStringList());
...
QStringListModel *KTextEditor::EditorPrivate::replaceHistoryModel()
{
    if (!m_replaceHistoryModel) {
        ...
        const QStringList history = cg.readEntry("Replace History", QStringList());
...
void KTextEditor::EditorPrivate::saveSearchReplaceHistoryModels()
{
    KConfigGroup cg(KSharedConfig::openStateConfig(), QStringLiteral("KTextEditor::Search"));
    if (m_searchHistoryModel) {
        cg.writeEntry("Search History", m_searchHistoryModel->stringList());
    }
    if (m_replaceHistoryModel) {
        cg.writeEntry("Replace History", m_replaceHistoryModel->stringList());
    }
}
