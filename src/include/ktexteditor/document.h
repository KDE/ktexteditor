...
Q_SIGNALS:
...
#if KTEXTEDITOR_ENABLE_DEPRECATED_SINCE(6, 8)
    /**
     ...
     */
    KTEXTEDITOR_DEPRECATED_VERSION(6, 8, "Not emitted any more. Ownership of the moving interface belongs to the user")
