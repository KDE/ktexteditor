...
public:
    ...
    // should the bracket match be highlighted during rendering?
    bool isBracketMatchHighlightActive() const;
...
public:
    ...
    bool evaluateScriptInternal(const QString &script, QVariant *result = nullptr);
